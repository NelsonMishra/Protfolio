import { IconBrandGithub, IconBrandLeetcode, IconBrandLinkedin, IconBrandYoutube } from "@tabler/icons-react";
import { socialLinks } from "./InfoCard";
...
const Social=()=>{
    ...
    return <div className="flex md-mx:hidden text-textColor items-center gap-10 fixed bottom-44 -left-44 rotate-90">
        {socialIcons}
